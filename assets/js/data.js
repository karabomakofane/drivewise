/* =============================================
   data.js — All static content for DriveWise
   Signs, rules, quiz questions, lesson text
   ============================================= */
...
/* =============================================
   GAME SIGNS
   id, label, emoji, color, action, points,
   msg, lesson (title + body), questions (3 each)
   ============================================= */
const GAME_SIGNS = [
  {
  ...
  },
  {
    ...
    questions:[
      ...
      { q:'What action is required when you see a warning sign?',
        ...
        exp:'Reduce speed and prepare to stop if needed. Slowing gives you time to react to the hazard.' },
  ...
  },
  {
    ...
    questions:[
      { q:'Who has right of way at a marked pedestrian crossing?',
        ...
        exp:'Pedestrians have right of way at all marked crossings. Failure to yield is a criminal offence.' },
  ...
  },
  {
    ...
    questions:[
      ...
      { q:'The railway barriers are coming down. What should you do?',
        ...
        exp:'Stop before the barriers. Never race them — they take 3–5 seconds to fully close.' },
  ...
  },
  {
    ...
    questions:[
      ...
      { q:'A green CLEAR sign appears. The correct reaction is:',
        ...
        exp:'No braking or steering needed. Smooth, controlled driving is the correct response.' },
